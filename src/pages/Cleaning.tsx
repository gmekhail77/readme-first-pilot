...
export default function Cleaning() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Page Title */}
      <section className="bg-gradient-to-br from-warm/20 to-warm-light/30 py-8 px-4">
        <div className="container mx-auto max-w-6xl">
          <h1 className="text-3xl font-bold text-foreground">House Cleaning</h1>
          <p className="text-lg mt-2 text-muted-foreground">Get instant pricing for professional cleaning services</p>
        </div>
      </section>
